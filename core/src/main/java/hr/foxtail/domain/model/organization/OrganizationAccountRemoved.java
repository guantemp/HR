/*
 * OrganizationAccountRemoved.java
 *
 ...
 */
public final class OrganizationAccountRemoved implements DomainEvent {
     ...
     * @param account
     */
    public OrganizationAccountRemoved(long id, Account account) {
        super();
        this.id = id;
