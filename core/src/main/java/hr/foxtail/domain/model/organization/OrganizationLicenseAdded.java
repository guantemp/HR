/*
 * @(#}InstitutionLicenseChanged.java
 *
 ...
 */
public final class OrganizationLicenseAdded implements DomainEvent {
    private long id;
    private License license;
    private LocalDateTime occurredOn;
    private int version;

    public OrganizationLicenseAdded(long id, License license) {
        super();
        this.id = id;
